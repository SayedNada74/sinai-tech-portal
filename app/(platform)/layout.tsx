                  ...
                  {isNotifOpen && (
                    <>
                      ...
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        className={cn(
                          "absolute mt-2 w-80 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-850 rounded-2xl shadow-xl z-50 overflow-hidden",
                          isRtl ? "left-0" : "right-0"
                        )}
                      >
                        <div className="p-4 border-b border-zinc-100 dark:border-zinc-850 flex justify-between items-center bg-zinc-50/50 dark:bg-zinc-900/40">
                          <h4 className="font-extrabold text-xs text-zinc-900 dark:text-zinc-100">
                            {t("التنبيهات والإشعارات", "Notifications & Alerts")}
                          </h4>
