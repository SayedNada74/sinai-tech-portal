      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            {t("تتبع وتوثيق جميع عمليات الإشراف والتغييرات بالمنصة، وتفقد بلاغات الأخطاء البرمجية.","Track admin operations, log security audit trails, and inspect system error incidents."
            )}
          </p>
        </div>
        ...
        <div className="space-y-4">
            ...
            <CardContent className="p-3 sm:p-4 flex flex-col md:flex-row justify-between gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                ...
                <Button
                  ...
                  className="text-red-600 border-red-200 hover:bg-red-50 text-xs font-bold gap-1.5 h-10 cursor-pointer w-full sm:w-auto justify-center"
                >
          ...
          <Card className="border border-zinc-200/60 dark:border-zinc-800/60 bg-white dark:bg-zinc-900 shadow-sm overflow-hidden">
            <div className="block sm:hidden text-[10px] text-zinc-400 p-2 text-center bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-100 dark:border-zinc-800">
              ⟷ {t("اسحب الجدول يميناً ويساراً لعرض كافة التفاصيل","Swipe table horizontally to view all columns")}
            </div>
            ...
            <CardContent className="pt-4 space-y-4">
              <div className="flex flex-col sm:flex-row gap-2">
                <Button
                  ...
                  className="text-xs font-bold text-amber-600 border-amber-300 w-full sm:w-auto justify-center"
                >
                ...
                <Button
                  ...
                  className="text-xs font-bold text-red-600 border-red-300 w-full sm:w-auto justify-center"
                >
