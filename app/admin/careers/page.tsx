      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            {t("نشر وإدارة التقديمات على الفرص الوظيفية والتدريب الصيفي للشركات المتعاقدة.","Publish & manage job listings, summer internships, and graduate career positions."
            )}
          </p>
        </div>
