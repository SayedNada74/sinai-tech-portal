      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            {t(
              "إضافة وتعديل المقررات الأكاديمية لجميع التخصصات، تحديث المتطلبات السابقة، وأرشفة المواد.",
              "Add, edit academic courses across departments, update prerequisites, and archive subjects."
            )}
          </p>
        </div>
