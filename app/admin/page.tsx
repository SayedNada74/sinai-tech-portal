      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            {t("مراقبة مؤشرات منصة الكلية، وتتبع التفاعلات والملفات وسجلات الرقابة الفعلية.","Monitor faculty platform indicators, track user interactions, resources, and live logs."
            )}
          </p>
        </div>
            ...
            <div className="space-y-3.5">
              {auditLogs.slice(0, 3).length > 0 ? (
                ...
                <div className="text-center py-10 space-y-2">
                  <History className="h-6 w-6 mx-auto text-primary dark:text-zinc-700" />
