    ...
    <SignupFormProvider>
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col justify-between relative overflow-x-hidden" dir={dir}>
        ...
        <header className="w-full px-3.5 sm:px-6 py-3.5 sm:py-6 flex items-center justify-between z-30 max-w-7xl mx-auto">
          ...
          >
            {lang ==="ar" ? <ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary dark:text-sky-400" /> : <ArrowLeft className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary dark:text-sky-400" />}
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            >
              <Globe className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary dark:text-sky-400" />
