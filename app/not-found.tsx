...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50 flex flex-col items-center justify-center p-6 text-center" dir="rtl">
      ...
      <div className="absolute w-72 h-72 bg-sky-600/10 rounded-full blur-3xl pointer-events-none" />

      <div className="relative space-y-6 max-w-md mx-auto">
        {/* Logo Icon */}
        <div className="mx-auto h-16 w-16 rounded-2xl bg-sky-600 flex items-center justify-center text-white shadow-xl shadow-sky-600/20">
          <GraduationCap className="h-9 w-9" />
        </div>

        {/* 404 Big Badge */}
        <div className="space-y-2">
          <span className="text-6xl font-black tracking-tight text-sky-600 dark:text-sky-400 block">404</span>
