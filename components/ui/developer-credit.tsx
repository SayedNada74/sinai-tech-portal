        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 w-48 bg-zinc-950 dark:bg-zinc-900 border border-zinc-800 shadow-2xl rounded-xl p-1.5 z-50 overflow-hidden"
              dir="ltr"
            >
