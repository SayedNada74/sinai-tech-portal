  ...
  return (
    <div className={`relative ${className}`} ref={ref}>
      ...
      >
        ...
        <ChevronDown className="h-3 w-3 sm:h-4 sm:w-4 text-zinc-400 opacity-70 shrink-0 ml-1" />
      </button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 mt-1 w-full min-w-[100px] max-h-56 overflow-y-auto bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-xl py-1"
            dir="ltr"
          >
            {!value && (
              <button
