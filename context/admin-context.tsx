...
const MOCK_FAQS: FAQItem[] = [
  ...
  { id: "faq-2", question: "كيف يتم حساب المعدل التراكمي (GPA) في الكلية؟", answer: "يتم بضرب نقاط تقدير كل مقرر في عدد ساعاته المعتمدة، ثم جمع إجمالي النقاط وقسمتها على إجمالي الساعات المسجلة.", category: "الدرجات", pinned: true },
  { id: "faq-3", question: "كيف يمكنني رفع معدلي التراكمي (GPA)؟", answer: "يمكنك إعادة دراسة المواد التي حصلت فيها على تقدير أقل من C لرفع التقدير وحساب المعدل مجدداً.", category: "الدرجات", pinned: false },
  { id: "faq-4", question: "ما هي شروط الالتحاق بمشروع التخرج (1)؟", answer: "يشترط إتمام 100 ساعة معتمدة بنجاح واجتياز المتطلبات المحددة بالقسم الأكاديمي الخاص بك.", category: "التخرج", pinned: false }
];
